...
export default withRouter(class Signup extends Component {
  ...
  /**
   * Build input values into form body
   * @returns {Promise}
   */
  submitSignup(e) {
    e.preventDefault();
    ...
    const surname = `surname=${ document.getElementById('surnameInput').value }`;
      ...
      <div className="SignupPanel">
        ...
        <form action="http://localhost:3030/signup" method="post">
          ...
          <div className={ s.submitWrapper }>
            <button id="signup-submit" type="submit" className="button-primary" onClick={ e => this.submitSignup(e) }>Submit</button>
          </div>
        </form>
